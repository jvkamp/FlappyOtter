namespace GleyMobileAds
{
    ...
    public class SettingsWindow : EditorWindow
    {
        ...
        private void UpdateAdvertiserSettings()
        {
            ...
            {
                AdvertiserSettings advertiser = new AdvertiserSettings(SupportedAdvertisers.Unity, "https://www.assetstore.unity3d.com/en/#!/content/66123", Constants.USE_UNITYADS);
                advertiser.platformSettings = new List<PlatformSettings>
                {
...
;
        ...
        private void SetAdmobAppID(int i)
        {
#if USE_ADMOB
            string androidAppId = advertiserSettings[i].platformSettings[(int)SupportedPlatforms.Android].appId.id;
            string iosAppID = advertiserSettings[i].platformSettings[(int)SupportedPlatforms.iOS].appId.id;
            Undo.RecordObject(GoogleMobileAds.Editor.GoogleMobileAdsSettings.Instance, "AdmobSettings");
            GoogleMobileAds.Editor.GoogleMobileAdsSettings.Instance.IsAdMobEnabled = true;
            GoogleMobileAds.Editor.GoogleMobileAdsSettings.Instance.AdMobAndroidAppId = androidAppId;
            GoogleMobileAds.Editor.GoogleMobileAdsSettings.Instance.AdMobIOSAppId = iosAppID;
